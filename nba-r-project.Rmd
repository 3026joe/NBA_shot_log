...
That amount of data is too big for the purpose of this analysis, so we will reduce the dimensions of both datasets.
...
Also, some variable selection will be made. We will choose 23 of the variables from the dataset.
